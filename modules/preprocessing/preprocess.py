...
class DataPreprocessor:
    ...
    def preprocess(self,
        ...
        #
        # The 2026-08-10 Sirmour export gained three trailing columns -
        # "Timestamp", "block_no", "source_file" - every value blank.
        # "Timestamp" and the real "TimeStamp" both normalise to
